package pizza.recette.service;

import pizza.recette.R;
import pizza.recette.classes.Produit;
import pizza.recette.dao.IDao;
...
public class ProduitService implements IDao<Produit> {
    ...
    private void seed() {
        data.add(new Produit("BARBECUED CHICKEN PIZZA", 30, R.mipmap.pizza1, "35 min",
        ...
        data.add(new Produit("BRUSCHETTA PIZZA", 50, R.mipmap.pizza2, "35 min",
        ...
        data.add(new Produit("SPINACH PIZZA", 20, R.mipmap.pizza3, "25 min",
        ...
        data.add(new Produit("DEEP-DISH SAUSAGE PIZZA", 80, R.mipmap.pizza4, "45 min",
        ...
        data.add(new Produit("HOMEMADE PIZZA", 40, R.mipmap.pizza5, "50 min",
        ...
        data.add(new Produit("PESTO CHICKEN PIZZA", 30, R.mipmap.pizza6, "50 min",
        ...
        data.add(new Produit("LOADED MEXICAN PIZZA", 30, R.mipmap.pizza7, "30 min",
        ...
        data.add(new Produit("BACON CHEESEBURGER PIZZA", 20, R.mipmap.pizza8, "20 min",
        ...
        data.add(new Produit("PIZZA MARGHERITA", 15, R.mipmap.pizza9, "30 min",
        ...
        data.add(new Produit("PEPPERONI-SAUSAGE STUFFED PIZZA", 50, R.mipmap.pizza10, "45 min",
